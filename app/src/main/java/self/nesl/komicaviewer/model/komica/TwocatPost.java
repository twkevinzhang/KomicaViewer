...
public class TwocatPost extends Post {
    public TwocatPost() { }

    public TwocatPost(String post_id, Element threadpost) {
    ...
    public void addPost(Element reply_ele){
        ...
        TwocatPost reply = new TwocatPost(reply_id, reply_ele);
        ...
        if (eles.size() <= 0) {
            ...
            for(Element resquote :eles){
                ...
                TwocatPost target= (TwocatPost) this.getPost(resquote_id);
