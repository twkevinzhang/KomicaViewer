...
public class HomeFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        host = getArguments() != null ? (Host) getArguments().getSerializable(COLUMN_HOST) : new KomicaHost();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // data and adapter
        homeViewModel.getPost().observe(getViewLifecycleOwner(), new Observer<KThread>() {
            @Override
            public void onChanged(KThread thread) {
                adapter.addAllPost(thread.getReplies(false,-1));
