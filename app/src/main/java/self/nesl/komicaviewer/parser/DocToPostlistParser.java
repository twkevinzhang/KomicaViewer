...
public class DocToPostlistParser {
    ...
    public DocToPostlistParser(Web web) {
        this.web = web;
    }

    public ArrayList<Post> tableToPostlist(Document doc, Board board) {
    ...
    public ArrayList<Post> jsonToPostlist(JSONArray json_arr, Board board) throws JSONException {
...
//            Log.e("DP", "post_detail:" + post_detail);
    ...
    public ArrayList<Post> homepageToPostlist(Document doc, Board board) {
        ArrayList<Post> postlist = new ArrayList<Post>();
...
//        }
    ...
    public ArrayList<Post> searchResultToPostlist(Document doc, Board board) {
        ArrayList<Post> postlist = new ArrayList<Post>();
